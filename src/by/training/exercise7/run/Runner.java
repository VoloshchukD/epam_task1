package by.training.exercise7.run;

import by.training.scanner.DataScanner;
import by.training.exercise7.unit.GeometryLogics;
import by.training.exercise7.unit.Point;
...
public class Runner {
    public static void main(String[] args) {
        ...
        String resultAsString = GeometryLogics.performResultAsString(comparationResult);
